...
contract Staking_Dapp{
    ...
    constructor(DummyToken _dummyToken,Tether_Token  _tetherToken)public{
    ...
    function stakeTokens(uint _amount)public {
        require(_amount>0,"amount con't be zero");   //if amount is zero or not


        tether_token.transferfrom(msg.sender,address(this)._amount);//transfer ether to contract address
        stakingBalance[msg.sender]=stakingBalance[msg.sender]+_amount;//updated the staking balnce of user
    ...
    function unstakeTokens()public{
        ...
        tether_token.transfer(msg.sender,balance);//we transferred back tether to user
